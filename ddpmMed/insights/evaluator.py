...
from ddpmMed.insights.cm_metrics import ALL_METRICS
from ddpmMed.insights.confusion_matrix import ConfusionMatrix
...
class NiftiEvaluator:
    def __init__(self, predictions: str,
        ...
        self.all_preds = glob.glob(os.path.join(self.predictions, f"*.nii.gz"))
        self.all_refs = glob.glob(os.path.join(self.references, f"*.nii.gz"))
